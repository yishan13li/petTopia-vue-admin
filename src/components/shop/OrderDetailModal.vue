...
.product-list {
    list-style: none; /* 移除預設的圓點 */
    padding: 0;
}

.product-item {
    display: flex;
    justify-content: space-between; /* 讓商品名稱在左，價格和數量在右 */
    align-items: center;
    padding: 5px 0; /* 增加一點間距 */
}

.product-info {
    flex: 1; /* 讓左側的產品資訊占據可用空間 */
}

.product-price {
    display: flex;
    align-items: center;
    gap: 200px; /* 讓價格與數量之間保留間距 */
}

.product-quantity {
    margin-left: 30px; /* 調整數量與價格的間距 */
}
